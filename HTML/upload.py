...
url =  '/Users/alfred/Downloads/Data.csv'
...
plt.savefig('/Users/alfred/Desktop/HTLM /numb.jpg')
plt.close()
dataset.plot(kind='box',y='time_spend_company')
plt.savefig('/Users/alfred/Desktop/HTLM /Outliers.jpg')
plt.close()

#Matrix Correlation
matrice=dataset.corr()
sns.heatmap(matrice)
plt.savefig('/Users/alfred/Desktop/HTLM /Heats.jpg')
plt.close()
...
plt.savefig('/Users/alfred/Desktop/HTLM /Corr.jpg')
plt.close()
...
plt.savefig('/Users/alfred/Desktop/HTLM /LogMatt.jpg')
plt.close()
plt.close()
...
plt.savefig('/Users/alfred/Desktop/HTLM /ROCLOG.jpg')
plt.close()
...
plt.title('ROC(s) avec predict_proba')
plt.legend(loc="lower right")
plt.savefig('/Users/alfred/Desktop/HTLM /ROCKNN.jpg')
plt.close()
...
plt.savefig('/Users/alfred/Desktop/HTLM /KnMat.jpg')
plt.close()
...
plt.savefig('/Users/alfred/Desktop/HTLM /RfMat.jpg')
plt.close()
...
plt.savefig('/Users/alfred/Desktop/HTLM /ROCRF.jpg')
plt.close()
...
plt.savefig('/Users/alfred/Desktop/HTLM /SvmMatt.jpg')
plt.close()
...
plt.savefig('/Users/alfred/Desktop/HTLM /ROCSVM.jpg')
plt.close()
for ax in fig.axes:
    ax.plot([0, 1], [0, 1], 'k--')
...
filename = 'file:///Users/alfred/Desktop/HTLM /' + 'projet2.html'
